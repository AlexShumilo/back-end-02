...
<div class="form_action">
    <div class="form_action_inner">
        <?php if (!$error) {  // если введены все данные и они отвечают всем требованиям, то заполняем их в файл (импровизированную базу данных)
            $file = $emailVal.'.txt';
            $text = "Получено сообщение. Адресант: " .$emailVal. "; Сообщение: " .$textareaVal. "; Файл: " .$_FILES['file']['name'];
            file_put_contents($file, $text, FILE_APPEND | LOCK_EX);            echo "Ваше сообщение успешно отправлено!";
            echo "<br>";
